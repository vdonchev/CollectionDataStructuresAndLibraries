namespace _03.FastSearchForStringsInTextFile
{
    ...
    public class AhoCorasickSearch
    {
        ...
        protected class Node
        {
            ...
            public Node(Node parent, char c)
            {
                ...
                this.Transition = new Dictionary<char, Node>();
            }
            ...
            {
                this.Transition.Add(node.Char, node);
            }

            public Node GetTransition(char c)
            {
                Node node = null;
                if (this.Transition.TryGetValue(c, out node))
                    return node;
                return null;
            }
        }
    ...
    public struct SearchResult : IEquatable<SearchResult>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Index == sr.Index && this.Match == sr.Match;
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return this.Index == other.Index && this.Match == other.Match;
        }
        ...
        {
            return this.Index.GetHashCode() ^ this.Match.GetHashCode();
        }
